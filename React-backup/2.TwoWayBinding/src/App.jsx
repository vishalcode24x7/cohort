  ...
  return (
    <div className='p-10 bg-black h-screen w-full'>
      <form
        ...
        className='w-60 h-60 gap-5 bg-gray-300 border rounded-2xl flex flex-col items-center justify-center'>
        ...
        <input
          className='border-2 py-3 px-8 rounded-2xl border-blue-950 bg-blue-400 text-white active:scale-95'
          type="submit" />
